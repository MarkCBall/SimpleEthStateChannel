...
export default {
    ...
    getPendingChannels: (dispatch, address) => {
        return (dispatch) => {
            fetch("35.182.146.179:3001/Channel/pending", {
                method: "GET",
                mode: "cors", 
                headers: {
                    "address":address
    ...
    getRequestedChannels: (dispatch, address) => {
        return (dispatch) => {
            fetch("35.182.146.179:3001/Channel/requested", {
                method: "GET",
                mode: "cors", 
                headers: {
                    "address":address
    ...
    getChannelDetails:(dispatch, CID) => {
        return (dispatch, getState) => {
            ...
            fetch("35.182.146.179:3001/Channel/", {
                method: "GET",
                mode: "cors", 
                headers: {
                    "cid":CID
    ...
    getHighestNonce: (dispatch, CID) =>{
        return (dispatch, getState) => {
            fetch("35.182.146.179:3001/Transaction/HighestNonce", {
                method: "GET",
                mode: "cors", 
                headers: {
                    "cid":CID
                ...
                fetch("35.182.146.179:3001/Transaction/getTx", {
                    method: "GET",
                    mode: "cors", 
                    headers: {
                        "cid":CID,
    ...
    getHighestSignedNonce: (dispatch, CID) =>{
        return (dispatch, getState) => {
            fetch("35.182.146.179:3001/Transaction/HighestSignedNonce", {
                method: "GET",
                mode: "cors", 
                headers: {
                    "cid":CID
